var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, "#0b2e13");
        gradient.addColorStop(0.6, "#0b2e13");
        gradient.addColorStop(1, "#ddfc5d");
        this.context.beginPath();
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = "rgba(62, 109, 23, 0.8)";
        this.context.lineWidth = 1;
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = "#0b2e13";
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = "rgba(62, 109, 23, 0.8)";
        this.context.lineWidth = 1;
...
var Player = {
    ...
    tracks: [
        {
            artist: "Join US!",
            song: "Tecky Code ARMY",
            url: "background_music.mp3"
        }
    ],
